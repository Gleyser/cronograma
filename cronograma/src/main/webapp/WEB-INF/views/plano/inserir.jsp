...
<div class="container" align="center">
							...
							<table class="table table-hover">
								...
								<c:forEach items="${modalidadesGratuitasDoPlano}" var="modalidadeGratuitaDoPlano">
									<tr>
										...
										<th scope="row">${modalidadeGratuitaDoPlano.tipoModalidade.descricao}</th>
										<td>				
										
										
										<div class="custom-control custom-switch">
												<input type="checkbox" class="custom-control-input"
													name = "modalidadesGratuitasDoPlano" value = "${modalidadeGratuitaDoPlano.tipoModalidade}" id = "${modalidadeGratuitaDoPlano.tipoModalidade}G" checked> <label
													class="custom-control-label" for="${modalidadeGratuitaDoPlano.tipoModalidade}G"></label>
											</div></td>
                                 ...
                                 <c:forEach items="${modalidadesGratuitasForaDoPlano}" var="modalidadeGratuitaForaDoPlano">
									<tr>							
									
										<th scope="row">${modalidadeGratuitaForaDoPlano.tipoModalidade.descricao}</th>
										<td><div class="custom-control custom-switch">
												<input type="checkbox" class="custom-control-input"
													name = "modalidadesGratuitasDoPlano" value = "${modalidadeGratuitaForaDoPlano.tipoModalidade}" id = "${modalidadeGratuitaForaDoPlano.tipoModalidade}G"> <label
													class="custom-control-label" for="${modalidadeGratuitaForaDoPlano.tipoModalidade}G"></label>
											</div></td>
							...
							<table class="table table-hover">
								...
								<c:forEach items="${modalidadesPagasDoPlano}" var="modalidadePagaDoPlano">
									<tr>
										...
										<th scope="row">${modalidadePagaDoPlano.tipoModalidade.descricao}</th>
										<td><div class="custom-control custom-switch">
												<input type="checkbox" class="custom-control-input"
													name = "modalidadesPagasDoPlano" value = "${modalidadePagaDoPlano.tipoModalidade}" id = "${modalidadePagaDoPlano.tipoModalidade}P" checked> <label
													class="custom-control-label" for="${modalidadePagaDoPlano.tipoModalidade}P"></label>
											</div></td>
                                ...
                                <c:forEach items="${modalidadesPagasForaDoPlano}" var="modalidadePagaForaDoPlano">
									<tr>
									
									
									 
										<th scope="row">${modalidadePagaForaDoPlano.tipoModalidade.descricao}</th>
										<td><div class="custom-control custom-switch">
												<input type="checkbox" class="custom-control-input"
													name = "modalidadesPagasDoPlano" value = "${modalidadePagaForaDoPlano.tipoModalidade}" id = "${modalidadePagaForaDoPlano.tipoModalidade}P"> <label
													class="custom-control-label" for="${modalidadePagaForaDoPlano.tipoModalidade}P"></label>
											</div></td>
	...
	<div class="modal fade" id="metasModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Objetivos do Plano</h5>
					<button class="close" type="button" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">×</span>
					</button>
